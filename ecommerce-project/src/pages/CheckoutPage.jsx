            ...
            <div className="checkout-page">
                ...
                <div className="checkout-grid">
                    <div className="order-summary">
                        {cart.map((cartItem) => { // this is used to generate a cart item container for each item in the cart, we are using the .map method to loop through each item in the cart array and create a cart item container for each one
                            return (
